...
let s:N2 = [ '#BDA9FF' , '#242322' , 206 , 234 ]
let s:N3 = [ '#e2e2e2' , '#4a4a4a' , 254 , 238 ]

let g:airline#themes#r2kolor#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#r2kolor#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#r2kolor#palette.insert_modified = {
      \ 'airline_c': [ '#242322' , '#7eaefd' , 234     , 111     , ''     ] ,
      \ }


let g:airline#themes#r2kolor#palette.replace = copy(g:airline#themes#kolor#palette.insert)
let g:airline#themes#r2kolor#palette.replace.airline_a = [ s:I2[0]   , '#005154' , s:I2[2] , 23      , ''     ]
...
let g:airline#themes#r2kolor#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
